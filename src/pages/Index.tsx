...
import { ArrowRight, CheckCircle, Clock, FileText, DollarSign } from 'lucide-react';
  ...
  return (
    <div className="min-h-screen">
      ...
      <main>
          ...
          <div className="max-w-7xl mx-auto px-5 md:px-10">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              {[
                ...
                >
                  <div className="bg-funding-blue/10 p-4 rounded-full mb-6">
                    {step.icon}
                  </div>
        ...
        <section id="testimonials" className="py-16 bg-funding-light-gray/50">
          <div className="max-w-7xl mx-auto px-5 md:px-10">
            <div className="text-center mb-16">
              <h2 className="text-3xl md:text-4xl font-bold text-funding-dark mb-4">
              ...
              <p className="text-funding-gray max-w-2xl mx-auto">
                Thousands of business owners have grown their businesses with our funding solutions
              </p>
            </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            ...
            <div>
              ...
              <ul className="space-y-2">
                <li><a href="#" className="text-gray-400 hover:text-white">Term Loans</a></li>
                <li><a href="#" className="text-gray-400 hover:text-white">Merchant Cash Advances</a></li>
                <li><a href="#" className="text-gray-400 hover:text-white">Lines of Credit</a></li>
                <li><a href="#" className="text-gray-400 hover:text-white">Equipment Financing</a></li>
              </ul>
            </div>
            ...
            <div>
              ...
              <ul className="space-y-2 text-gray-400">
                ...
                <li className="flex items-start">
                  ...
                  <span>info@growthpathadvisory.com</span>
                </li>
                <li className="flex items-start">
                  <svg className="h-5 w-5 mr-2 mt-0.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
