                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-x-8 gap-y-4 text-left">
                  ...
                  <div>
                    ...
                    <div className="flex items-center">
                      ...
                      <span className="font-medium text-funding-dark">Pending Document Verification</span>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div className="space-y-6 mb-10">
                ...
                <div className="flex items-start">
                  ...
                  <div className="text-left pt-1">
                    ...
                    <p className="text-funding-gray mb-3">
                      A funding specialist will review your application and documents within 24-48 hours.
                    </p>
                    <CustomButton 
                      variant="outline"
